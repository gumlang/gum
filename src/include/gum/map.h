...
GUM_API void* gum_map_add(gum_map_t* map, const char* key);
GUM_API void gum_map_remove(gum_map_t* map, const char* key);
GUM_API void* gum_map_get(gum_map_t* map, const char* key);

GUM_API void gum_mapiter_create(gum_map_t* map, gum_mapiter_t* iter);
